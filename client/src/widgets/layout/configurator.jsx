...
import CalendarCard from "../calender/calender-card"
      ...
      <div className="py-4 px-6">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-5 gap-x-2">
            <div className="col-span-2 border border-gray-300"><img loading="lazy" src="https://getweeklyupdate.com/blog/wp-content/uploads/2018/02/1.jpg" alt="event-img" /></div>
            <div className="col-span-3">
               <Typography variant="h6" color="blue-gray">
                  Team Meeting
                </Typography>
                <Typography variant="small" color="gray">
                  Task Management project meeteing ...
                </Typography>
            </div>
          </div>
